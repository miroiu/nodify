...
namespace Nodifier
{
    ...
    {
        public static void FocusElement(this IGraph graph, IGraphElement node)
        {
        ...
        public static void FocusLocation(this IGraph graph, Point point)
        {
            graph.FocusLocation(point.X, point.Y);
        }
